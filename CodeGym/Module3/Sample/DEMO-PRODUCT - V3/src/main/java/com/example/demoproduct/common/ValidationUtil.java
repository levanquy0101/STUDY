...
public class ValidationUtil {
    ...
    private static final String BENH_AN = "BA-\\d{4}$";
...
//    private static final String NUMBERS_PHONE = "";
    ...
    public static boolean isValidPositonInterger(String num) {
        // Validate số nguyên dương
        Pattern pattern = Pattern.compile(POSITIVE_NUMBERS);
    ...
    public static boolean isValidBenhAn(String name) {
        // Validate tên của điên thoại
        Pattern pattern = Pattern.compile(BENH_AN);
