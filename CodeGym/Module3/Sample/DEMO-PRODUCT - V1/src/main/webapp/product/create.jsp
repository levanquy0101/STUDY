...
<%--          <input type="hidden" class="input-q1" placeholder="Nhập" name="id">--%>
          <input type="text" class="input-q1" placeholder="Nhập" name="name">
        <c:if test="${messError != null}">
            <div class="error">
                <small>${messError}</small>
            </div>
        </c:if>
          <input type="text" class="input-q1" placeholder="Nhập" name="price">
<%--        <c:if test="${messError != null}">--%>
<%--            <div class="error">--%>
<%--                <small>${messError}</small>--%>
<%--            </div>--%>
<%--        </c:if>--%>
          <input type="text" class="input-q1" placeholder="Nhập" name="about">
